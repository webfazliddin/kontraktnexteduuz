          ...
          <b-row>
            <b-col>
              <div class="pricing-box rounded px-4 pt-4 pb-2">
                <fieldset>
                  <b-row>
                    <b-col sm="12" md="6" lg="6" class="my-1">
                      <custom-label
                        :label="$t('FIO')"
                  ...
                  <b-row>
                      ...
                      <custom-select
                        ...
                        :style="
                          ...
                          Application.contractSideTypeId == null
                            ...
                            : ' '
                        "
                        v-model="GetByApplication.contractSideTypeId"
                    ...
                    <b-col sm="12" md="6" lg="6" class="my-1">
                      <custom-select
                        ...
                        v-model="GetByApplication.contractSumTypeId"
                    ...
                    <b-col
                      ...
                      class="mt-2 my-1"
                      v-if="
                        Application.genderId == 2 &&
                        Application.eduTypeId == 2 &&
                        Application.contractTypeId == 4
                      "
                    >
                ...
                <fieldset
                  class="mt-4 mb-3"
                  v-if="GetByApplication.contractSideTypeId == 2"
                >
                  <b-row>
                ...
                <fieldset
                  v-if="
                    ...
                    GetByApplication.contractSideTypeId == 2
                  "
                >
...
import MyApplicationForChangeService from "../services/myapplicationforchange.service";
export default {
  components: {
    BIconPlus,
    CustomSelect,
  ...
  created() {
    ...
    if (
      ...
      MyApplicationForChangeService.GetByApplicationId(this.$route.params.id)
        .then((res) => {
          this.Application = res.data;
          this.FromDtmData.IsFromDtm = this.Application.fromDtm;
          if (!!res.data.contractor) {
  ...
  methods: {
    ...
    ChangeContractSum() {
      ...
      if (
        this.Application.eduFormId == 2 ||
        this.Application.eduTypeId == 2 ||
        this.Application.contractTypeId == 4
      ) {
        this.isDisabled = false;
      }
      this.Application.contractSumTypeId = this.GetByApplication.contractSumTypeId
      if (
        this.Application.eduFormId != 2 &&
        this.Application.contractTypeId != 4
      ) {
    ...
    SaveData() {
      ...
      if (this.Application.fromDtm == true) {
        ...
        //   oldApplicationId: this.Application.oldApplicationId,
        //   oldContractInvoiceId: this.Application.oldContractInvoiceId,
        //   contractorId: this.Application.contractorId,
        //   contractorInn: this.Application.inn,
        //   this
        //   contractorName: this.Application.contractorName,
        // };
        this.GetByApplication.oldApplicationId =this.Application.oldApplicationId;
        this.GetByApplication.oldContractInvoiceId =this.Application.oldContractInvoiceId;
        this.GetByApplication.contractorId = this.Application.contractorId;
        this.GetByApplication.contractorInn = this.Application.contractorInn;
        this.GetByApplication.contractorName = this.Application.contractorName;
        MyApplicationForChangeService.Create(this.GetByApplication)
          .then((res1) => {
            this.SaveLoading = false;
