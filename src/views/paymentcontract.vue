      ...
      <div class="mainApplication">
        <b-row>
          <b-col sm="12" md="6" lg="6">
            <h4 class=""> {{ $t("To‘lov shartnoma") }}</h4>
          </b-col>
        </b-row>
        <hr class="line">
        <b-row>
          <div class="edu-info">
              <b-list-group>
                <b-list-group-item class="edu-list-group">
                  <span class="edu-title">F.I.SH.:</span>
                  <span class="edu-name"><b>31010976640025 - ASOMOV ZIYODILLA HIKMATILLA O‘G‘LI</b></span>
                </b-list-group-item>
                <b-list-group-item class="edu-list-group">
                  <span class="edu-title">Hujjat raqami:</span>
                  <span class="edu-name"><b>B3732311446/K</b></span>
                </b-list-group-item>
                <b-list-group-item class="edu-list-group">
                  <span class="edu-title">Sanasi:</span>
                  <span class="edu-name"><b>16.06.2023</b></span>
                </b-list-group-item>
                <b-list-group-item class="edu-list-group">
                  <span class="edu-title">Ariza turi:</span>
                  <span class="edu-name"><b>Shartnomani o`zgartirish</b></span>
                </b-list-group-item>
                <b-list-group-item class="edu-list-group">
                  <span class="edu-title">Taʼlim turi:</span>
                  <span class="edu-name"><b>Bakalavr</b></span>
                </b-list-group-item>
                <b-list-group-item class="edu-list-group">
                  <span class="edu-title">Taʼlim yo‘nalishi:</span>
                  <span class="edu-name"><b>5410900 - Ipakchilik va tutchilik</b></span>
                </b-list-group-item>
                <b-list-group-item class="edu-list-group">
                  <span class="edu-title">Ariza ko'rib chiquvchi:</span>
                  <span class="edu-name"><b>TOSHKENT DAVLAT AGRAR UNIVERSITETI</b></span>
                </b-list-group-item>
                <b-list-group-item class="edu-list-group">
                  <span class="edu-title">Holati:</span>
                  <span class="">
                    <div class="status-name-success">Qabul qilindi</div>
                  </span>
                </b-list-group-item>
                <hr class="line">
                <div class="d-flex mb-3 justify-content-end mr-3">
                  <b-button class="edit-contract-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <path d="M12.9 6.69335C12.4467 4.39335 10.4267 2.66669 8 2.66669C6.07333 2.66669 4.4 3.76002 3.56667 5.36002C1.56 5.57335 0 7.27335 0 9.33335C0 11.54 1.79333 13.3334 4 13.3334H12.6667C14.5067 13.3334 16 11.84 16 10C16 8.24002 14.6333 6.81335 12.9 6.69335ZM11.3333 8.66669L8.23333 11.7667C8.1 11.9 7.89333 11.9 7.76 11.7667L4.66667 8.66669H6.66667V6.00002H9.33333V8.66669H11.3333Z" fill="#1677FF"/>
                    </svg>
                    <span class="text">Shartnomani tahrirlash</span>
                  </b-button>
                  <b-button class="edit-contract-btn ml-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <b-row>
            ...
            <div class="pricing-box rounded px-4 pt-4 pb-2">
              ...
              <b-row class="mt-2">
                <b-col sm="12">
                  ...
                  >
                    <b-icon-cursor scale="0.8"></b-icon-cursor>
                    {{ $t("send") }}
                  </a> -->
                  <a
                    v-if="item.canRevoke"
          ...
          >
            <b-button
              @click="
                $router.push({ name: 'EditApplication', params: { id: 0 } })
              "
              size="lg"
              class="anim-opacity"
              pill
            ...
            >
              <span class="px-5">
                <b-icon-plus></b-icon-plus> {{ $t("Add") }}</span
              >
            </b-button>
          </b-col> -->
        </b-row>
