    ...
    <b-overlay :show="Loading" :style="{ height: Loading ? '100vh' : 'auto' }">
      <div v-if="Application.fromDtm != true && !Loading">
        <div class="container" style="margin-top: 100px">
          <b-row class="mt-2">
            <b-col sm="12" lg="6">
              <h2 @click="$router.go(-1)" style="cursor: pointer" class="title1">
          ...
          <b-row>
            <b-col>
              <div class="rounded px-4 pt-4 pb-2">
                <fieldset>
                  <b-row>
                    <b-col sm="12" md="6" lg="5" class="my-1">
                      <custom-label :label="$t('FIO')" :content="Application.student"></custom-label>
                    </b-col>
                    <b-col sm="12" md="6" lg="5" class="my-1">
                      <custom-label :label="$t('pinfl')" :content="Application.pinfl"></custom-label>
                    </b-col>
                  </b-row>
                </fieldset>
                <fieldset class="mt-3">
                  <legend class="legend">{{ $t("StudentInfo") }} :</legend>
                  <b-row>
                    <b-col sm="12" md="4" lg="5" class="my-1">
                      <custom-label
                    ...
                    <b-col sm="12" md="4" lg="5" class="my-1">
                      <custom-label :label="$t('edulevel')" :content="Application.eduLevel"></custom-label>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col sm="12" md="4" lg="5" class="my-1">
                      <custom-label :label="$t('speciality')" :content="Application.eduSpeciality"></custom-label>
                    </b-col>
                    <b-col sm="12" md="6" lg="5" class="my-1">
                      <custom-label :label="$t('eduType')" :content="Application.eduType"></custom-label>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col sm="12" md="6" lg="5" class="my-1">
                      <custom-label :label="$t('eduForm')" :content="Application.eduForm"></custom-label>
                    </b-col>
                    <b-col sm="12" md="6" lg="5" class="my-1">
                      <custom-label :label="$t('eduLanguage')" :content="Application.eduLanguage"></custom-label>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col sm="12" md="6" lg="5" class="my-1" v-if="!!Application.socialCategory">
                      <custom-label
                ...
                <fieldset class="mt-3 mb-3">
                  <legend class="legend">{{ $t("Contract") }} :</legend>
                  <b-row>
                    <b-col sm="12" md="6" lg="5" class="my-1">
                      <custom-label :label="$t('eduYear')" :content="Application.eduYear"></custom-label>
                    </b-col>
                    <b-col sm="12" md="6" lg="5" class="my-1">
                      <custom-label
                  ...
                  <b-row>
                    ...
                    <b-col sm="12" md="6" lg="5" class="my-1">
                      <custom-label :label="$t('contractType')" :content="Application.contractType"></custom-label>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col v-if="!Application.stateExpense" sm="12" md="6" lg="5" class="my-1">
                      <custom-label
                ...
                <fieldset
                  ...
                  "
                >
                  <legend class="legend">{{ $t("Contractor") }} :</legend>
                  <b-row>
                    <b-col sm="12" md="12" lg="12">
                      <custom-label :label="$t('fullname')" :content="ContractorData.fullName"></custom-label>
                    </b-col>
                  </b-row>
                </fieldset>
                <fieldset class="mt-3 mb-3">
                  <b-row>
                    ...
                    >
                      <div class="ml-3">
                        {{ $t("ContractPrice") }}
                        <p
                          class="font-weight-bold applicantionText"
                        ...
                        <span class="d-flex p-1" v-if="isContractEightPercent">
                          <p class="mr-1 applicantionText ml-3" style="white-space: nowrap">
                            {{
                          ...
                          <p style="color: red" class="mr-1 applicantionText">10%</p>
                          <p class="mr-1 applicantionText">=</p>
                          <p
  ...
  created() {
    ...
    ApplicationService.Get(this.$route.params.id)
      .then(res => {
        ...
        if (
          this.Application.eduFormId != 2 &&
          this.Application.contractTypeId != 4
        ) {
